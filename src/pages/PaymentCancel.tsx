    ...
    <Layout>
      <div className="flex flex-col items-center justify-center min-h-screen bg-[#1A1C24]">
        <div className="bg-[#222429] p-8 rounded-lg shadow-lg flex flex-col items-center">
          ...
          <p className="text-gray-300 mb-6">Você pode tentar novamente a qualquer momento.</p>
          <a href="#/plans" className="bg-gray-600 text-white px-6 py-2 rounded font-semibold hover:bg-gray-700">Voltar para planos</a>
        </div>
      </div>
    </Layout>
  );
